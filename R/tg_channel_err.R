...
#' @description Allows you to get the "ERR" indicator in dynamics by day, week, month.
...
#'
#' @references See also \href{https://api.tgstat.ru/docs/ru/channels/err.html}{TGStat API Documentation of metrod channels/err}
#'
#' @return tibble with channel ERR dinamics
#' @export
#'
#' @details
